		...
		try {
			if (translations) {
				if (translations.default === undefined)
					throw new Error(
						"[Two-Mi18n] The 'default' property is not defined."
					);
				if (translations[translations.default] === undefined)
					throw new Error(
						`[Two-Mi18n] The default language "${translations.default}" is not defined in the translations array.`
					);
			}
		} catch (error) {
			throw new Error(
				"[Two-Mi18n] Something is wrong with the translation array:\n" +
					error.message
			);
		}
